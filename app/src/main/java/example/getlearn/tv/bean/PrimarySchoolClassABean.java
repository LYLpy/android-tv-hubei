...
public class PrimarySchoolClassABean implements Parcelable {
    public PrimarySchoolClassABean(int status, List<XuekeListBean> xuekeList, List<CourseListBean> courseList) {
        this.status = status;
        this.xuekeList = xuekeList;
        this.courseList = courseList;
    }

    public PrimarySchoolClassABean() {
        super();
    }

    @Override
    public String toString() {
        return "PrimarySchoolClassABean{" +
                "status=" + status +
                ", xuekeList=" + xuekeList +
    ...
    protected PrimarySchoolClassABean(Parcel in) {
    ...
    public static final Parcelable.Creator<PrimarySchoolClassABean> CREATOR = new Parcelable.Creator<PrimarySchoolClassABean>() {
        @Override
        public PrimarySchoolClassABean createFromParcel(Parcel source) {
            return new PrimarySchoolClassABean(source);
        }

        @Override
        public PrimarySchoolClassABean[] newArray(int size) {
            return new PrimarySchoolClassABean[size];
        }
    };
}
