...
public class VlcPlayerController implements IMediaController {
    ...
    public Runnable getmLastSeekBarRunnable() {
        return mLastSeekBarRunnable;
    }
    ...
    public boolean ismInstantSeeking() {
        return mInstantSeeking;
    }
    ...
    public void setmDragging(boolean mDragging) {
        this.mDragging = mDragging;
    }

    public TextView getmCurrentTimeView() {
        return mCurrentTimeView;
    }

    public TextView getmEndTimeView() {
        return mEndTimeView;
    }
    ...
    private void initControllerView(View v) {
        ...
        player_ui_more = v.findViewById(R.id.player_ui_more);
