...
/**
 * 自定义简单日志，日志内容写入到文件
 * Created by 刘佳佳 on 2020/3/6.
 */
public class MyLog {
    private static Boolean MYLOG_SWITCH = true; // 日志文件总开关
    private static Boolean MYLOG_WRITE_TO_FILE = true;// 日志写入文件开关
    private static char MYLOG_TYPE = 'v';// 输入日志类型，w代表只输出告警信息等，v代表输出所有信息
    private static String MYLOG_PATH_SDCARD_DIR = Environment.getDataDirectory().getPath();// 日志文件在/data中的路径
    private static int SDCARD_LOG_FILE_SAVE_DAYS = 0;// sd卡中日志文件的最多保存天数
    private static String MYLOGFILEName = "getlearn_teacher_log.txt";// 本类输出的日志文件名称
